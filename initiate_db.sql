...
--     additionalBytesFactor float DEFAULT 1.8 -- The additional bytes factor used for calculating the step size. Must be equal or greater then 1.
-- )
...
CREATE TABLE IF NOT EXISTS test_data(
  ...
  test_uuid UUID DEFAULT(uuid_generate_v4()),
  test_nanoid VARCHAR(12) DEFAULT (nanoid()),
  test_short_uuid VARCHAR(30),
  test_val BIGINT,
  test_equals BOOLEAN
);
